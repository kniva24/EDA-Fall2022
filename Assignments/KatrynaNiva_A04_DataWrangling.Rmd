...
PM25_2018 <- read_csv("Data/Raw/EPAair_PM25_NC2018_raw.csv")
PM25_2019 <- read_csv("Data/Raw/EPAair_PM25_NC2019_raw.csv")
...
#PM25_2018 <- mutate(PM25_2018, AQS_PARAMETER_DESC == "PM2.5")
...
colnames(O3_2018)[colnames(O3_2018) == "Site.Name"] ="Site Name"
...
EPAairData.2 <-
  ...
  mutate(EPAairData, Month = month(Date)) %>%
  mutate(EPAairData, Year = year(Date))
