...
mapView(huc8_sf2) + mapView(huc8_sf)
...
EnviroAtlas_WindEnergy <- read.csv('https://raw.githubusercontent.com/ENV859/EnviroAtlasData/main/Wind_Energy.csv', colClasses = c('HUC_12' = 'factor'))%>%
...
geom_sf(data = countries_sf_join, aes(fill = E_POV), alpha = 0.3) +
