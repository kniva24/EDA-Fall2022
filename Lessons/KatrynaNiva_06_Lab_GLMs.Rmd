...
EPAair <- read.csv("~/R/EDA-Fall2022/Data/Processed/EPAair_O3_PM25_NC1819_Processed.csv", stringsAsFactors = TRUE)
...
#use as.factor to convert to factor so they will group together
