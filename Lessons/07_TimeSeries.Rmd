...
#smaller the right hand bar, larger the representation of that factor within the data
...
#must run on a time series -- if s is positive -- increasing
...
#do ADF first -- if you get stochastic trend then your work is done, if not then do mann kendall
