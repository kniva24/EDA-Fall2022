...
matrix1[4, ] #
matrix1[ , 3] #
matrix1[c(12, 14)] # indicates two dimensional location
matrix1[c(12:14)] #: indicates slice
matrix1[2:4, 1:3] #
...
# Data Frames ---- a list of lists
d <- c(1, 2, 3, 4) # What type of vector?
e <- c("red", "white", "red", NA) # all list must have same number of elements if merging into a date frame = What type of vector?
f <- c(TRUE, TRUE, TRUE, FALSE) # What type of vector?
dataframe1 <- data.frame(d,e,f) #

dataframe1[1:2,] # omitting columns gives all columns
...
```{r DataExercise-1a}
highF <- c(a=80, b=83, c=79, d=82, e=86, f=79, g=76, h=80, i=76, j=82)
lowF <- c(a=60, b=62, c=71, d=69, e=59, f=61, g=62, h=54, i=61, j=54)
...
weather <- data.frame(highF, lowF, highC, lowC)
...
sd(highC)
sd(lowC)
lapply(weather, sd) #use lapply to apply a funtion to an entire dataframe or matrix
...
today <- Sys.Date() #returns current date
